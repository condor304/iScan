...
{
    return [CIFilter filterWithName:@"CIColorControls" keysAndValues:kCIInputImageKey, image, @"inputBrightness", [NSNumber numberWithFloat:0.0], @"inputContrast", [NSNumber numberWithFloat:1.24], @"inputSaturation", [NSNumber numberWithFloat:0.0], nil].outputImage;
}
